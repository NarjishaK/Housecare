  ...
  return (
    <React.Fragment>
      <div style={{ textAlign: "center" }}>
        <Card>
          <CardBody>
            <div style={{ display: "flex", alignItems: "flex-end" ,flexWrap:"nowrap", gap: "20px",alignContent:"stretch",justifyContent:"space-evenly",placeContent:"stretch space-evenly;"}}>
